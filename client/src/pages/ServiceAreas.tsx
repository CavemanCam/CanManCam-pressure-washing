      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-sm">
            We serve Isle of Palms, Old Village, Park West, Hamlin Plantation, Carolina Park, Dunes West, Crowfield, Planters Pointe, Long Point, Shem Creek, Lexington Park, Pin Oak, and surrounding Mount Pleasant areas.
          </p>
        </div>
      </main>
